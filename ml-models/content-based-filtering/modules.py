...
def load_data():
    item_train = genfromtxt('data/old_content_item_train.csv', delimiter=',')
    user_train = genfromtxt('data/old_content_user_train.csv', delimiter=',')
    y_train = genfromtxt('data/old_content_y_train.csv', delimiter=',')
